							...
							if ( ! empty( $content_modules ) ) :
								...
								<div class="rich-right-side utop w-richtext">
									...
									foreach ( $content_modules as $content_module ) :
										if ( 'text_module' === $content_module['acf_fc_layout'] ) :
											// phpcs:ignore
										...
										elseif ( 'image_module' === $content_module['acf_fc_layout'] && ! empty( $content_module['image'] ) ) :
											...
											++$image_counter;
										elseif ( 'question_module' === $content_module['acf_fc_layout'] && ! empty( $content_module['text'] ) ) :
											?>
											<p><em><?php echo esc_html( $content_module['text'] ); ?></em></p>
											<?php
										elseif ( 'blockquote_module' === $content_module['acf_fc_layout'] && ! empty( $content_module['text'] ) ) :
											?>
