...
?>
				<div class="usual-page">
					...
					<footer class="footer">
						<div class="sub-from w-form">
							<form id="email-form" name="email-form" data-name="Email Form" method="get" class="form" data-wf-page-id="65eef967e4c8e68931e902ea" data-wf-element-id="175357ac-dc97-ffe8-4592-427bd0633297">
				...
				<div class="clickers"><a href="#" class="hidden-clicker w-inline-block"></a><a href="#" class="hidden-clicker-2 w-inline-block"></a><a href="#" class="hidden-clicker-out w-inline-block"></a></div>
			</div>
		</div>
		<!-- FOOTER CODE -->
