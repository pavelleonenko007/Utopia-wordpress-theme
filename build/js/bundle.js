...
function initBarba() {
  barba_js__WEBPACK_IMPORTED_MODULE_2___default().Pjax.start();
  barba_js__WEBPACK_IMPORTED_MODULE_2___default().Prefetch.init();

  // var ScaleTransition = Barba.BaseTransition.extend({
  // 	start: function () {
  // 		/**
  ...
  var Homepage = barba_js__WEBPACK_IMPORTED_MODULE_2___default().BaseView.extend({
    namespace: 'homepage',
    onEnter: function () {
      console.log('enter');
