...
<div class="usual-page">
	<h1 class="heading _2"><?php pll_e( 'Sorry the page you requested was not found' ); ?></h1>
	<div class="rich-right-side _404page w-richtext">
		<p><?php pll_e( 'Go to our' ); ?> <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php pll_e( 'main page' ); ?></a></p>
	</div>
</div>
